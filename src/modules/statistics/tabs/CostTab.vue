...
import { Wallet, Building2, Type } from 'lucide-vue-next'
...
const maxModelCost = computed(() => Math.max(...stats.filteredSortedModelStats.map(m => m.cost), 0.001))

const sortOptions: { key: SortBy; label: string; icon: typeof Wallet }[] = [
