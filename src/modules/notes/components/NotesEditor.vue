...
import { Check, X, Pencil, Sparkles, Loader2, Plus, Hash } from 'lucide-vue-next'
  ...
  <div class="notes-editor" @keydown="onKeydown">
    ...
    <div class="meta-bar">
      <div class="meta-row title-row">
        ...
        <div class="title-area">
          ...
          <template v-else>
            ...
            <span class="title-display">{{ note.title || t('notes.titlePlaceholder') }}</span>
          </template>
        </div>
      ...
      <div class="meta-row">
        ...
        <div class="meta-field">
          <span class="meta-label">{{ t('notes.date') }}</span>
          <input
            v-model="note.date"
            type="date"
        ...
        <!-- Group -->
        <div class="meta-field">
          <span class="meta-label">{{ t('notes.group') }}</span>
          <select
            :value="note.groupId"
            class="meta-input group-select"
            @change="store.setGroupId(($event.target as HTMLSelectElement).value)"
          >
    ...
    <div class="editor-toolbar">
      ...
      <div class="toolbar-right">
        ...
        <span v-else-if="autoSaveStatus === 'saved'" class="save-status success">{{ t('notes.saved') }}</span>
...
.title-area:hover .title-edit-trigger {
  opacity: 1;
}
...
.group-select { width: 140px; font-size: 12px; }
